...
SAFE_DAY_TRADER_PROFILE: Dict[str, Any] = {
    ...
    "portfolio_target_positions": 3,
    "portfolio_deploy_pct": 0.30,
    "portfolio_max_position_weight": 0.08,
    "portfolio_max_deploy_usd": 750.0,
    "max_order_notional_usd": 75.0,
    "max_position_notional_usd": 225.0,
    "portfolio_min_order_notional_usd": 20.0,
...
RISKY_DAY_TRADER_PROFILE: Dict[str, Any] = {
    ...
    "portfolio_deploy_pct": 0.85,
    "portfolio_max_position_weight": 0.22,
    "portfolio_max_deploy_usd": 2500.0,
    "max_order_notional_usd": 350.0,
    "max_position_notional_usd": 800.0,
